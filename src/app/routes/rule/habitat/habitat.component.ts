...
@Component({
    ...
    styleUrls: ['./habitat.component.less'],
})
export class HabitatComponent implements OnInit {
    ...
    ngOnInit() {
        ...
        this.api.getHabMddList().subscribe(
            data => {
    ...
    popToFirst(id, isTop) {
        ...
        this.api
            .habOrder(postIds.join(','), this.current_option.id)
            .subscribe(data => {
    ...
    selectOption(op, list) {
        ...
        this.api.getHabMessageList(params).subscribe(
            data => {
                this.loading = false;
    ...
    buildPostData() {
        ...
        const postData: any = {
            ...
            content_type,
            mdd: mdd_select.id,
            usage_type: usage_type.length ? usage_type : ['habitat'],
            ...time_range,
        };
        return postData;
    }
    ...
    deleteMessage(id, mdd_id) {
        ...
        this.api.deleteHabMessage(params).subscribe(data => {
